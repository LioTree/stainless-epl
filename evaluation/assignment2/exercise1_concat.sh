...
time $python_cmd $cluster_path --filenames=$sample_solution,$joined_files --extract=$extract_target --compare=Value.concat --assn2=true --output=exercise1_concat.json
