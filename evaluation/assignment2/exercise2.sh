...
time $python_cmd $cluster_path --filenames=$sample_solution,$joined_files --extract=$extract_target --assn2=true --subfns-equiv=true --fake-exs=Value --output=exercise2.json 
