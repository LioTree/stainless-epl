...
time $python_cmd $cluster_path --filenames=$sample_solution,$joined_files --extract=$extract_target --assn2=true --compare=Value.length --output=exercise1_length.json
