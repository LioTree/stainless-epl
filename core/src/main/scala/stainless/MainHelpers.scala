...
trait MainHelpers extends inox.MainHelpers { self =>
  ...
  override protected def getOptions: Map[inox.OptionDef[_], Description] = super.getOptions - inox.solvers.optAssumeChecked ++ Map(
    ...
    equivchkplus.optMatchExhaustiveness -> Description(EquivChk, "Ensure Match exhaustiveness"),
    equivchkplus.optAssn1 -> Description(EquivChk, "Preprocess assignment1 of EPL"),
    equivchkplus.optAssn2 -> Description(EquivChk, "Preprocess assignment2 of EPL"),
    equivchkplus.optSubFnsEquiv -> Description(EquivChk, "Using the equivalence of the marked subfunctions to replace the equivalence of the original function"),
    equivchkplus.optTransformation -> Description(EquivChk, "Translation to use for equivalence checking"),
//    equivchkplus.optExternPureDefs -> Description(EquivChk, "Consider f1, c2, o3 ... as extern and pure functions"),
    equivchkplus.optFakeExercises -> Description(EquivChk, "Use fake exercises f1, o2 ..."),
    equivchkplus.optExtractTarget -> Description(EquivChk, "Extract f1, c2, o3 and its dependencies"),
//    equivchkplus.optPublicDefs -> Description(EquivChk, "Consider definitions f1, c2, o3 … as public definitions"),
